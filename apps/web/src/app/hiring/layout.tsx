...
import { Users, LogOut, Briefcase } from "lucide-react";
    ...
    <div className="flex h-screen bg-zinc-50 font-sans text-zinc-900">
      ...
      <aside className="w-64 bg-white border-r border-zinc-200 flex flex-col hidden md:flex">
        <div className="h-16 flex items-center px-6 border-b border-zinc-200">
          <Link href="/hiring/dashboard" className="flex items-center gap-2 text-indigo-600 font-bold text-xl tracking-tight">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="h-16 bg-white border-b border-zinc-200 flex items-center px-6 md:hidden">
          <Link href="/hiring/dashboard" className="text-indigo-600 font-bold text-lg flex items-center gap-2">
